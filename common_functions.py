...
class CommonFunctions:
    ...
    def categorize_name_transactions(self,df):
        ...
        df.loc[
            df["Category"].isin(["Suspense", "Payment Made", "Payment Received"])
            & df["Description"].apply(self.is_name)
            & (df["Category"] != "NameTransaction"),
            "Category",
        ] = "NameTransaction"
    ...
    def Bl_eligibility_bankwise(self, trans, data, eod):
        payment_for_bl = self.pmt_bl()  # Factor used in loan eligibility calculation
